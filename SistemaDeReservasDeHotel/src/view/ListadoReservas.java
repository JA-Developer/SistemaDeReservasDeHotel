...
public class ListadoReservas extends javax.swing.JFrame {
    ...
    private void cargarDatos(){
        ...
        List<Object> reservas = reservaDAO.getAllDTO();
        for(Object reserva_uncast : reservas){
            ReservaDTO reserva = (ReservaDTO) reserva_uncast;
            modeloTabla.addRow(new Object[]{ reserva.getId(), reserva.getFechaDeInicio(), reserva.getHabitacionId(), reserva.getHoras(), reserva.getHabitacionPrecioHora(), reserva.getHuespedNombre() });
        }
    }
    ...
    private void initComponents() {
        ...
        setName("ListadoReservas"); // NOI18N
        ...
        tablaReservas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Fecha de inicio", "Id de habitacion", "Horas", "Precio por hora", "Nombre de huésped"
            }
        ));
        tablaReservas.setName("tablaReservas"); // NOI18N
        ...
        lab_Titulo.setText("Listado de Reservas");
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        // TODO add your handling code here:
        int filaSeleccionado = tablaReservas.getSelectedRow();
        ...
        FormularioReservas p1 = new FormularioReservas(this, true, "UPD", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        long id = (long) modeloTabla.getValueAt(filaSeleccionado, 0);
        FormularioReservas p1 = new FormularioReservas(this, true, "DLT", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);

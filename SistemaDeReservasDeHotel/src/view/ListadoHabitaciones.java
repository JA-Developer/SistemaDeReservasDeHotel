...
public class ListadoHabitaciones extends javax.swing.JFrame {
    ...
    private void cargarDatos(){
        ...
        List<Object> habitaciones = habitacionDAO.getAll();
        for(Object habitacion_uncast : habitaciones){
            Habitacion habitacion = (Habitacion) habitacion_uncast;
            modeloTabla.addRow(new Object[]{ habitacion.getId(), habitacion.getCantidadDeCamas(), habitacion.getPrecioPorHora() });
        }
    }
    ...
    private void initComponents() {
        ...
        setName("ListadoHabitaciones"); // NOI18N
        ...
        tablaHabitaciones.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cantidad de camas", "Precio por hora"
            }
        ));
        tablaHabitaciones.setName("tablaHabitaciones"); // NOI18N
        tablaHabitaciones.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        ...
        lab_Titulo.setText("Listado de Habitaciones");
    ...
    private void btn_InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InsertarActionPerformed
        ...
        FormularioHabitaciones p1 = new FormularioHabitaciones(this, true, "INS", 0);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        // TODO add your handling code here:
        int filaSeleccionado = tablaHabitaciones.getSelectedRow();
        ...
        FormularioHabitaciones p1 = new FormularioHabitaciones(this, true, "UPD", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        long id = (long) modeloTabla.getValueAt(filaSeleccionado, 0);
        FormularioHabitaciones p1 = new FormularioHabitaciones(this, true, "DLT", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);

...
public class ListadoPagos extends javax.swing.JFrame {
    ...
    private void cargarDatos(){
        ...
        List<Object> pagos = pagoDAO.getAll();
        for(Object pago_uncast : pagos){
            Pago pago = (Pago) pago_uncast;
            modeloTabla.addRow(new Object[]{ pago.getId(), pago.getReservaId(), pago.getNoFactura(), pago.getRtn(), pago.getFecha(), pago.getMonto() });
        }
    }
    ...
    private void initComponents() {
        ...
        tablaPagos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Id de reserva", "No. de factura", "Rtn", "Fecha", "Monto"
            }
        ));
        ...
        lab_Titulo.setText("Listado de Pagos");
    ...
    private void btn_InsertarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_InsertarActionPerformed
        ...
        FormularioPagos p1 = new FormularioPagos(this, true, "INS", 0);
    ...
    private void btn_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editarActionPerformed
        // TODO add your handling code here:
        int filaSeleccionado = tablaPagos.getSelectedRow();
        ...
        FormularioPagos p1 = new FormularioPagos(this, true, "UPD", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);
    ...
    private void btn_EliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_EliminarActionPerformed
        ...
        long id = (long) modeloTabla.getValueAt(filaSeleccionado, 0);
        FormularioPagos p1 = new FormularioPagos(this, true, "DLT", id);
        p1.setLocationRelativeTo(null);
        p1.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ListadoPagos().setVisible(true);
            }
        });
    }
